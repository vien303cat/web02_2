...
CREATE TABLE `date` (
  `date_seq` int(10) UNSIGNED NOT NULL,
  `date_txt` int(11) NOT NULL,
...
INSERT INTO `good` (`good_seq`, `good_acc`, `good_newseq`) VALUES
(13, 'www', 4),
(16, 'qqq', 1),
(18, 'qqq', 3),
(19, 'qqq', 4);
...
CREATE TABLE `que1` (
  `que1_seq` int(10) UNSIGNED NOT NULL,
  `que1_txt` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `que1` (`que1_seq`, `que1_txt`) VALUES
(1, '你最常做什麼運動來促進健康體能呢?'),
...
CREATE TABLE `que2` (
  `que2_seq` int(10) UNSIGNED NOT NULL,
  `que2_txt` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `que2_q1` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `que2` (`que2_seq`, `que2_txt`, `que2_q1`) VALUES
...
CREATE TABLE `quelog` (
  `quelog_seq` int(10) UNSIGNED NOT NULL,
  `quelog_acc` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `quelog_q1` int(10) NOT NULL,
  `quelog_q2` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `quelog` (`quelog_seq`, `quelog_acc`, `quelog_q1`, `quelog_q2`) VALUES
(1, 'qqq', 1, 2),
(2, 'qqq', 1, 4),
(3, 'qqq', 2, 7),
(4, 'qqq', 2, 9);
...
--
ALTER TABLE `que1`
  ADD PRIMARY KEY (`que1_seq`);

--
-- 資料表索引 `que2`
--
ALTER TABLE `que2`
  ADD PRIMARY KEY (`que2_seq`);

--
-- 資料表索引 `quelog`
--
ALTER TABLE `quelog`
  ADD PRIMARY KEY (`quelog_seq`);
...
--
ALTER TABLE `date`
  MODIFY `date_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- 使用資料表 AUTO_INCREMENT `good`
--
ALTER TABLE `good`
  MODIFY `good_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- 使用資料表 AUTO_INCREMENT `member`
--
ALTER TABLE `member`
  MODIFY `member_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- 使用資料表 AUTO_INCREMENT `news`
--
ALTER TABLE `news`
  MODIFY `news_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- 使用資料表 AUTO_INCREMENT `que1`
--
ALTER TABLE `que1`
  MODIFY `que1_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用資料表 AUTO_INCREMENT `que2`
--
ALTER TABLE `que2`
  MODIFY `que2_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- 使用資料表 AUTO_INCREMENT `quelog`
--
ALTER TABLE `quelog`
  MODIFY `quelog_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
